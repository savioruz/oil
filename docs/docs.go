    ...
    "paths": {
        "/api/auth/login": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "User logged in successfully. Response contains access_token. If remember=false, refresh_token is also included in response. If remember=true, refresh_token is only set as HTTP-only cookie.",
                        "schema": {
        ...
        "/api/auth/refresh-token": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Token refreshed successfully. Response contains access_token. If using cookie, new refresh_token is only in cookie. If using request body, new refresh_token is in response body.",
                        "schema": {
                    ...
                    "422": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/response.ValidationErrors"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
