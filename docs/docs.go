    ...
    "paths": {
        ...
        "/v1/auth/login": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "User logged in successfully. Both access_token and refresh_token are returned in the response. If remember=true, refresh_token is also set as an HTTP-only cookie.",
                        "schema": {
        ...
        "/v1/auth/refresh-token": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Token refreshed successfully. Returns new access_token and refresh_token.",
                        "schema": {
